...
export default function CarrierGroupDetail() {
  ...
  // TODO: Fetch carrier group data from API using ID from route params
  const CARRIER_GROUP_DETAILS = [
    {
      title: 'Carrier Group Description',
      value: 'Insurance Group A',
    },
    {
  ...
  const handleDelete = () => {
    if (confirm('Are you sure you want to delete this carrier group?')) {
      ...
      console.log('Delete carrier group')
  ...
  const handleEdit = () => {
    ...
    router.push('/settings/carrier-group/edit/1')
  }
